...
<div class="content-wrapper">
    <section class="content-header">
        <div class="page-pos">当前位置：<span style="color: #ee7b33;">管理中心 > 产品管理 > 产品详情</span></div>
    </section>
            ...
            <div class="col-xs-12">
                <div class="box zr-box">
                    <div class="box-body" style="padding-top: 30px;">
                        <div id="goodsContent" class="tab-content" data-id="${goods.goods.id}">
                                    ...
                                    <div class="col-xs-10 gright">
                                        <div class="form-horizontal">
                                            <div class="form-group" style="padding-top: 30px;">
                                                ...
                                                <div class="col-sm-7">
                                                    <input class="form-control" type="text" id="name" value="${goods.goods.name}" maxlength="50" placeholder="必填项，不能超过50字符或汉字">
                                                    <p class="tips"></p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-xs-10 gright" style="padding-top: 30px;">
                                        <div class="form-horizontal">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-7">
                                                    <div class="col-sm-4" style="padding-left: 0">
                                                        <select class="form-control" id="category1" data-cate="${goods.goods.category1}" data-id="${goods.goods.categoryId1}"></select>
                                                    </div>
                                                    <div class="col-sm-4" style="padding-left: 0">
                                                        <select class="form-control" id="category2" data-cate="${goods.goods.category2}" data-id="${goods.goods.categoryId2}"></select>
                                                    </div>
                                                    <div class="col-sm-4" style="padding-left: 0">
                                                        <select class="form-control" id="category3" data-cate="${goods.goods.category3}" data-id="${goods.goods.categoryId3}"></select>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-7">
                                                    <input class="form-control" type="text" id="colour" value="${goods.goods.colour}" placeholder="请输入颜色">
                                                    <p class="tips"></p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-7">
                                                    <input class="form-control" type="text" id="price" value="${goods.goods.price?c}" placeholder="请输入价格">
                                                    <p class="tips"></p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-7">
                                                    <input class="form-control" type="text" id="taobaoPrice" value="${goods.goods.taobaoPrice?c}" placeholder="请输入淘宝/天猫价">
                                                    <p class="tips"></p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-7">
                                                    <input class="form-control" type="text" id="jdPrice" value="${goods.goods.jdPrice?c}" placeholder="请输入京东价">
                                                    <p class="tips"></p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-7">
                                                    <textarea class="form-control" id="remarks" placeholder="请输入备注">${goods.goods.remarks}</textarea>
                                                    <p class="tips"></p>
                                                </div>
                                            </div>
                                ...
                                <div class="row" style="margin-top: 2px;">
                                    ...
                                    <div class="col-xs-10 gright" style="padding:30px;">
                                        <div class="form-horizontal">
                                            <div id="skuboxarea">
                                                <div class="skubox">
                                                    <#list goods.list as item>
                                                        <div class="skuitem" data-id="${'n'+item_index}" data-level="${item_index}">
                                                            <div style="border:1px solid #e7eaec;padding:10px;margin-bottom: 10px;">
                                                                <div class="form-group" style="margin-bottom: 0">
                                                                    <div class="col-sm-12">
                                                                        <div class="input-group inputgroupspc">
                                                                            <select name="${'n'+item_index}" class="form-control supplierName">
                                                                                <option value="-1">请选择供应商</option>
                                                                                <#list supplier as sitem>
                                                                                    <option value="${sitem.id}" <#if sitem.id==item.supplierId>selected</#if>>${sitem.name}</option>
                                                                                </#list>
                                                                            </select>
                                                                            <input type="text" name="${'n'+item_index}" class="form-control supplyPrice" value="${item.supplyPrice?c}" placeholder="对应价格">
                                                                            <div class="input-group-btn">
                                                                                <a href="javascript:;" class="btn ydcbtn btn-danger" onclick="removeSpec('${'n'+item_index}')"><i class="fa fa-remove"></i></a>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                        ...
                        <div class="row" style="margin-top:30px;">
                            ...
                            <div class="col-xs-4">
                                <button class="btn ydcbtn bg-olive" id="saveBtn" style="width: 130px;">
                                    <i class="fa fa-save"></i> &nbsp;保存
                                </button>
                                <#if goods.goods.status==0>
                                    <button class="btn btn-danger ydcbtn " id="deleteBtn" style="width: 130px;">
                                        <i class="fa fa-trash"></i> &nbsp;删除
                                    </button>
                                </#if>
                                <button class="btn ydcbtn bg-lightgray" onclick="window.location.href='/management/goods/list'" style="margin-left: 20px;">
...
<script type="text/javascript">
    ...
    $.ydcAjax("GET","/mApi/category/list","","json","application/json",function(data){
        ...
        var cateId1=$('#category1').attr('data-id');
        var cateId2=$('#category2').attr('data-id');
        var cateId3=$('#category3').attr('data-id');

        $("#category1,#category2,#category3").html("");
        if(data.list.length>0){
            $.each(data.list,function(idx,obj){
                if(obj.id==cateId1){
                    sList=data.list[idx].list;
                    $("#category1").append("<option selected value='"+obj.id+"'>"+obj.name+"</option>");
                }else{
            ...
            if(sList.length>0){
                var tList=[];
                $.each(sList,function(cidx,cobj){
                    if(cobj.id==cateId2){
                        tList=sList[cidx].list;
                        $("#category2").append("<option selected value='" + cobj.id + "'>" + cobj.name + "</option>");
                    }else{
                        $("#category2").append("<option value='" + cobj.id + "'>" + cobj.name + "</option>");
                    }
                });
                if(tList.length>0){
                    $.each(tList,function (tidx,tobj) {
                        if(tobj.id==cateId3){
                            $("#category3").append("<option selected value='" + tobj.id + "'>" + tobj.name + "</option>");
                        }else{
    ...
    $('#saveBtn').on('click',function () {
        ...
        $.ydcAjax("PUT","/mApi/goods/update",JSON.stringify(data),"json","application/json",function (data) {
            $.smallTips("修改成功！请到列表中查看",true,1000);
            setTimeout(function(){
                window.location.href="/management/goods/list";
            },1000);
        },function (error) {
            if($.parseJSON(error.responseText).message=='invalid status'){
                $.ydcModal("fa fa-warning","操作提示","修改失败!先下架产品编辑","我知道了","");
            }else{
    ...
    $('#deleteBtn').on('click',function () {
        var id=$('#goodsContent').attr('data-id');
